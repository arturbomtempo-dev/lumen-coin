...
const palettes: Record<MarioCharacter, Record<string, string>> = {
  mario:  { hat: '#E52521', shirt: '#E52521', overall: '#1F4FD8', skin: '#FBC8A0', hair: '#3A1F0B', shoe: '#5B2B0E' },
  luigi:  { hat: '#39B54A', shirt: '#39B54A', overall: '#1F4FD8', skin: '#FBC8A0', hair: '#3A1F0B', shoe: '#5B2B0E' },
  peach:  { hat: '#F4C7E1', shirt: '#FF8AC2', overall: '#FF8AC2', skin: '#FBD9B5', hair: '#F0C040', shoe: '#C03070' },
  toad:   { hat: '#FFFFFF', shirt: '#FFFFFF', overall: '#1F4FD8', skin: '#FBE2C0', hair: '#FFFFFF', shoe: '#5B2B0E', spot: '#E52521' },
  yoshi:  { hat: '#39B54A', shirt: '#39B54A', overall: '#FFFFFF', skin: '#FBD9B5', hair: '#39B54A', shoe: '#E2622E', spot: '#1F4FD8' },
  bowser: { hat: '#39B54A', shirt: '#F2A93B', overall: '#39B54A', skin: '#F2A93B', hair: '#E52521', shoe: '#1F1F1F', spot: '#FFFFFF' },
}
</script>
...
<template>
  ...
  >
    ...
    <template v-if="character === 'peach'">
      ...
      <rect x="5" y="1" width="1" height="1" fill="#1F4FD8" />
      <rect x="7" y="1" width="1" height="1" fill="#E52521" />
